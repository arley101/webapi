...
NATURAL_LANGUAGE_MAP = {
    ...
    # Marketing
    "crear campaña facebook": "crear_campana_meta",
    "crear campaña google": "crear_campana_google_ads",
...
async def process_chatgpt_query(query: str, params: dict) -> JSONResponse:
    ...
    try:
        ...
        try:
            ...
            # Ejecutar la función (sync o async)
            if hasattr(action_function, '__call__'):
