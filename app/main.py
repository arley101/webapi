...
try:
    from app.api.routes.openai_direct import router as openai_direct_router
except Exception as e:
...
if openai_direct_router is not None:
    app.include_router(openai_direct_router, prefix="/api/v1")
